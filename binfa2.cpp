...
#include <fstream>
#include <string.h>		// fájlból olvasunk, írunk majd
...
private: int Number;
  ...
  int dontes(int argc, char* argv[])
  { ClassOne Object;
if (std::string(argv[4]) == "-pr"); {Object.Set(1);}
